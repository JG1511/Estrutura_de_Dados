...
const form = document.getElementById("cadastro_de_tarefa") as HTMLFormElement
...
const barra_de_pesquisa = document.getElementById("barra_de_pesquisa") as HTMLFormElement
const pesquisa = document.getElementById("pesquisa") as HTMLInputElement
...
const descricao_do_html = document.getElementById("descricao") as HTMLInputElement
const data_do_html = document.getElementById("date") as HTMLInputElement
const tabela = document.getElementById("lista_do_carlos_maia")
let id = 1

const tarefas = new Map<number, Tarefas>()
getLocalStorage()
...
function adcionar_tarefa(){
    ...
    const tarefa : Tarefas = {descricao : descricao_da_tarefa, data : data_da_tarefa}
...
function limpar_tarefa(id : number){
...
function pesquisar_tarefa(id : number){
    for(let [chave,valor] of tarefas.entries()){
...
function Salvar_tarefas_no_localStorage() : void {
...
function getLocalStorage(): void {
    ...
    if (dados) {
        ...
        const lista: [number, Tarefas][] = JSON.parse(dados);
